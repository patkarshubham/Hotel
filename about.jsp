						...
						<div class="row icon_box_row">
							...
							<div class="col-lg-4">
								<div class="icon_box text-center">
									...
									<div class="icon_box_title"><h3>Swimming Pool</h3></div>
									<div class="icon_box_text">
							...
							<div class="col-lg-4">
								<div class="icon_box text-center">
									...
									<div class="icon_box_title"><h3>Luxury Resort</h3></div>
									<div class="icon_box_text">
										<p>In vitae nisi aliquam, scelerisque leo a, volutpat sem. Vivamus rutrum.</p>
									</div>
								</div>
						...
						<div class="contact_info_box d-flex flex-column align-items-center justify-content-center">
							<ul class="contact_info_list">
								...
								<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<div class="contact_info_text">+91 95949 39291</div>
								</li>
								<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<div class="contact_info_text">myhotel@gmail.com</div>
								</li>
							</ul>
						</div>
