...
<div class="super_container">
			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<div class="section_title"><h1>Services & Facilities</h1></div>
			...
			<div class="row icon_box_row">
				...
				<div class="col-xl-4 col-md-6">
					<div class="icon_box text-center">
						...
						<div class="icon_box_title"><h2>Spa & Wellness</h2></div>
						<div class="icon_box_text">
							<p>In vitae nisi aliquam, scelerisque leo a, volutpat sem. Vivamus rutrum dui fermentum eros hendrerit, id lobortis leo volutpat.</p>
						</div>
					</div>
				...
				<div class="col-xl-4 col-md-6">
					<div class="icon_box text-center">
						...
						<div class="icon_box_title"><h2>Snorkeling</h2></div>
						<div class="icon_box_text">
							<p>In vitae nisi aliquam, scelerisque leo a, volutpat sem. Vivamus rutrum dui fermentum eros hendrerit, id lobortis leo volutpat.</p>
						</div>
					</div>
				...
				<div class="col-xl-4 col-md-6">
					<div class="icon_box text-center">
						<div class="icon_box_icon"><img src="images/icon_9.svg" alt="https://www.flaticon.com/authors/monkik"></div>
						<div class="icon_box_title"><h2>One day trips</h2></div>
						<div class="icon_box_text">
							<p>In vitae nisi aliquam, scelerisque leo a, volutpat sem. Vivamus rutrum dui fermentum eros hendrerit, id lobortis leo volutpat.</p>
						</div>
					</div>
	...
	<div class="facilities">
		<div class="container">
			<div class="row facilities_row">
				
				<!-- Facility -->
				<div class="col-lg-4">
					<div class="facility text-center">
						<div class="facility_image"><img src="images/facilities_1.jpg" alt="https://unsplash.com/@simonmigaj"></div>
						<div class="facility_title"><h2>Sunset Dinners</h2></div>
						<div class="facility_text">
							<p>In vitae `nisi aliquam, scelerisque leo a, volutpat sem. Vivamus rutrum dui fermentum eros hendrerit, id lobortis leo volutpat.</p>
						</div>
						<div class="button facility_button"><a href="#">read more</a></div>
					</div>
				</div>
				...
				<div class="col-lg-4">
					<div class="facility text-center">
						<div class="facility_image"><img src="images/facilities_2.jpg" alt="https://unsplash.com/@rhemakallianpur"></div>
						<div class="facility_title"><h2>Room Service</h2></div>
						<div class="facility_text">
							<p>In vitae nisi aliquam, scelerisque leo a, volutpat sem. Vivamus rutrum dui fermentum eros hendrerit, id lobortis leo volutpat.</p>
						</div>
						<div class="button facility_button"><a href="#">read more</a></div>
				...
				<div class="col-lg-4">
					<div class="facility text-center">
						<div class="facility_image"><img src="images/facilities_3.jpg" alt="https://unsplash.com/@clemono2"></div>
						<div class="facility_title"><h2>Our Restaurant</h2></div>
						<div class="facility_text">
							<p>In vitae nisi aliquam, scelerisque leo a, volutpat sem. Vivamus rutrum dui fermentum eros hendrerit, id lobortis leo volutpat.</p>
						</div>
						<div class="button facility_button"><a href="#">read more</a></div>
