				...
				<div class="col">
					...
					<div class="buttons">
						...
						<div class="buttons_container d-flex flex-row align-items-start justify-content-start flex-wrap">
							<div class="e_button button button_1"><a href="#">search</a></div>
							<div class="e_button button button_2"><a href="#">search</a></div>
							<div class="e_button button button_3"><a href="#">search</a></div>
						</div>
					</div>

					<!-- Accordions & Tabs -->
					<div class="acc_and_tabs">
						<div class="section_title_container_2">
								...
								<div class="tabs">
									<div class="tabs_container">
										<div class="tabs d-flex flex-row align-items-center justify-content-start flex-wrap">
											<div class="tab">Lorem ipsum dolor</div>
											<div class="tab">Pellentesque lobortis</div>
											<div class="tab active">Neque non sem</div>
										</div>
						...
						<div class="row loaders_row">
							...
							<div class="col-xl-3 col-md-6 loader_col">
								...
								<div class="loader_container text-center">
									...
									<div class="loader_content">
										<div class="loader_title">Ocupancy</div>
									</div>
								</div>
							</div>
							...
							<div class="col-xl-3 col-md-6 loader_col">
								...
								<div class="loader_container text-center">
									...
									<div class="loader_content">
										<div class="loader_title">Pool time</div>
									</div>
								</div>
							</div>
							...
							<div class="col-xl-3 col-md-6 loader_col">
								...
								<div class="loader_container text-center">
									...
									<div class="loader_content">
										<div class="loader_title">Couples</div>
									</div>
								</div>
							</div>
